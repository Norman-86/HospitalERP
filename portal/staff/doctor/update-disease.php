<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $query1 = "SELECT * FROM disease WHERE diseaseID='$id' ";
...
<head>
    ...
    <title>Update Symptom | Doctor | WAKA CMEC Hospital</title>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" role="menu" style="background-color:rgb(249,249,249);">
                                ...
                                <li role="presentation"><a href="diseases.php">View Diseases</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
            ...
            <form method="POST">
                <div class="form-group">
                    <div id="formdiv">
                        ...
                        <?php 
                            include('validate/update-disease.php'); 
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-12">
                                <p style="font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">Disease Name <a class="text-danger">*<a/></p>
                                <input class="form-control" type="text" name="name" value="<?php echo $row['name'];?>" placeholder="Enter Disease Name" style="margin-left:0px;font-family:Roboto, sans-serif;">
                            </div>
                            <div class="col-md-12">
                                <p style="font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">Associated Gender <a class="text-danger">*<a/></p>
                                <select class="form-control" name="gender">
                                        ...
                                        <optgroup label="Select Gender">
                                            ...
                                            <option value="All" <?php if($row['gender'] == "All"){echo "selected='selected'";}?> >All</option>
                                        </optgroup>
                                </select>
                            </div>
                            <div class="col-md-12">
                                <p style="font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">Associated Age<a class="text-danger">*<a/></p>
                                <select class="form-control" name="age">
                                        <option value="">- Select Age -</option>
                                        <optgroup label="Select Age">
                                            <option value="0 to 5 yrs" <?php if($row['age'] =="0 to 5 yrs"){echo "selected='selected'";}?> >0 to 5 yrs</option>
                                            <option value="Below 18 yrs" <?php if($row['age'] =="Below 18 yrs"){echo "selected='selected'";}?> >Below 18 yrs</option>
                                            <option value="18 to 40 yrs" <?php if($row['age'] =="18 to 40 yrs"){echo "selected='selected'";}?> >18 to 40 yrs</option>
                                            <option value="+40 yrs" <?php if($row['age'] =="+40 yrs"){echo "selected='selected'";}?> >+40 yrs</option>
                                            <option value="All" <?php if($row['age'] =="All"){echo "selected='selected'";}?> >All</option>
                                        </optgroup>
                                </select>
                            </div>
                            <div class="col-md-12">
                                <p style="font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">Other Details (Optional) </p>
                                <textarea class="form-control" name="details" placeholder="Other details about this disease (Optional)" style="margin-left:0px;font-family:Roboto, sans-serif;"><?php echo $row['other_details']; ?></textarea>
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px; text-align:center; padding-top:24px;">
                            <div class="col-md-12">
                                <button type="submit" name="submit" onClick="return confirm('Sure you want to update this disease?')" style="padding:5px 20px;color:rgb(1,1,1);">Update</button>
                            </div>
                        </div>
                        <?php }} ?>
                    </div>
