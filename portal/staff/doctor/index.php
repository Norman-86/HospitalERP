...
<head>
    ...
    <title>Dashboard | Doctor | WAKA CMEC Hospital</title>
                        ...
                        if(isset($_SESSION['success'])=='true')
                            {
                                echo'<div class="alert alert-success absolue center text-center" role="alert">
                                        ...
                                        <span class="text-success">Patient Treated successfully</span>
                                    </div>';
                                    ...
                                    unset($_SESSION['diagnosedSymptoms']); 
                                    unset($_SESSION['addSymptom1']); 
                                    unset($_SESSION['addSymptom2']); 
                                    unset($_SESSION['details']);
                                    unset($_SESSION['results']);
                            }
                        if(isset($_SESSION["patientTest"])){
                            echo'<div class="alert alert-success absolue center text-center" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">×</span>
                                    </button>
                                    <span class="text-success">Lab Tests for patient <b>'.$_SESSION["patientTest"].'</b> submitted successfully</span>
                                </div>';
                            unset($_SESSION['patientTest']); 
                            unset($_SESSION['success']); 
                                    unset($_SESSION["added"]); 
                                    unset($_SESSION["symptom"]); 
                                    unset($_SESSION['assign']); 
