...
<head>
    ...
    <title>Lab Tests | Doctor | WAKA CMEC Hospital</title>
    ...
    <div class="row" style="width:100%;max-width:960px;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        <form method="POST" action="" onSubmit="return validate();">
            <div class="col-md-12" style="margin-bottom:1%;padding-top:2px;padding-bottom:2px;background-color:rgb(239,239,239);">
                ...
                <?php 
                    if(isset($_SESSION["labPatient"]) && isset($_SESSION["labVisit"])){
                ?>
                    <div class="col-md-6">
                        <button type="submit" name="submit_for_test" title="Submit tests for verification" onclick="return confirm('You are about to submit selected tests to lab for verification\nWant to continue?');" style="padding:5px 20px;color:rgb(1,1,1);">Send Tests to Lab</button>
                    </div>
                <?php } ?>
