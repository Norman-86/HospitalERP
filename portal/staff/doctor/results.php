                ...
                <div class="col-md-12">
                    <form method="POST">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-right" style="font-size:12px;font-weight:normal;color:rgb(3,3,3);">
                                                <textarea  readonly class="form-control" style="max-width:100%;max-height:100%;"><?php echo $rows['result'];?></textarea>
                                            </td>
                                        </tr>
                                    <?php    
                                            }
                        ...
                        <div class="col-md-12 text-center">
                            <button type="submit" name="submit"  style="padding:5px 20px;color:rgb(1,1,1);">Diagnose Disease</button>
                        </div>
                     <?php }} ?>
                    </form> 
                </div>
