...
<head>
    ...
    <title>Disease | Doctor | WAKA CMEC Hospital</title>
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" role="menu" style="background-color:rgb(249,249,249);">
                                <li class="active" role="presentation"><a href="add-disease.php">Add Disease</a></li>
            ...
            <form method="POST">
                <div class="form-group">
                    <div id="formdiv">
                        ...
                        <?php 
                            include('validate/add-disease.php'); 
                            ...
                            if(isset($_SESSION['new'])=='True')
                            {
                                ...
                                echo'<div class="alert alert-success absolue center text-center" role="alert">
                                        ...
                                        <span class="text-success">Disease Added Successfully</span>
                                    </div>';
                                    unset($_SESSION['new']); 
                            }
                        ?>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="text" name="name" value="<?php echo $name;?>" placeholder="Enter Symptom Name" style="margin-left:0px;font-family:Roboto, sans-serif;">
                            </div>
                            <div class="col-md-12">
                                ...
                                <select class="form-control" name="gender">
                                        ...
                                        <optgroup label="Select Gender">
                                            ...
                                            <option value="All" <?php if($gender == "All"){echo "selected='selected'";}?> >All</option>
                                        </optgroup>
                                </select>
                            </div>
                            <div class="col-md-12">
                                ...
                                <select class="form-control" name="age">
                                        ...
                                        <optgroup label="Select Age">
                                            <option value="0 to 5 yrs" <?php if($age =="0 to 5 yrs"){echo "selected='selected'";}?> >0 to 5 yrs</option>
                                            <option value="Below 18 yrs" <?php if($age =="Below 18 yrs"){echo "selected='selected'";}?> >Below 18 yrs</option>
                                            <option value="18 to 40 yrs" <?php if($age =="18 to 40 yrs"){echo "selected='selected'";}?> >18 to 40 yrs</option>
                                            <option value="+40 yrs" <?php if($age =="+40 yrs"){echo "selected='selected'";}?> >+40 yrs</option>
                                            <option value="All" <?php if($age =="All"){echo "selected='selected'";}?> >All</option>
                                        </optgroup>
                                </select>
                            </div>
                            <div class="col-md-12">
                                <p style="font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">Other Details (Optional) </p>
                                <textarea class="form-control" name="details" placeholder="Other details about this disease (Optional)" style="margin-left:0px;font-family:Roboto, sans-serif;"><?php echo $details; ?></textarea>
                            </div>
                        </div>
