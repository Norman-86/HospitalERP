...
<head>
    ...
    <title>Add Staff | Human Resource | WAKA CMEC Hospital</title>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="<?php echo $mail1;?>" placeholder="example@mail.com" name="mail1">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category">
                                    ...
                                    <optgroup label="Category">
                                        ...
                                        <option value="Doctor" <?php if($category == "Doctor"){echo 'selected="selected"';}?> >Doctor</option>
                                        <option value="Lab Technician" <?php if($category == "Lab Technician"){echo 'selected="selected"';}?> >Lab Technician</option>
                                        <option value="Pharmacist" <?php if($category == "Pharmacist"){echo 'selected="selected"';}?> >Pharmacist</option>
                                        <option value="Procurement" <?php if($category == "Procurement"){echo 'selected="selected"';}?> >Procurement</option>
                                        <option value="Registry" <?php if($category == "Registry"){echo 'selected="selected"';}?> >Registry</option>
                                    </optgroup>
                                </select>
                            </div>
                        </div>
