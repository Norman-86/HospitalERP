...
<head>
    ...
    <title>Update Staff | Human Resource | WAKA CMEC Hospital</title>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12 text-center">
                            <div style="width:100%;max-width:130px;height:130px;margin:0 auto;overflow:hidden;">
                                <a href="../../uploads/user/<?php echo $name1['pic'];?>" target="_blank">
                                    <img src="../../uploads/user/<?php echo $name1['pic'];?>" alt="<?php echo $name1['staffNo'];?>" style="width:100%;max-width:130px;">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-9 col-sm-12">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <label for="dtp_input2"  class="control-label">Date of Birth &nbsp;<a class="text-danger">*</a></label>
                                <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                    <input class="form-control" type="text"value ="<?php echo date_format(date_create($name1['dob']),"Y-m-d");?>" placeholder="yyyy-mm-dd" name="dob">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="control-label">Photo &nbsp;<a class="text-danger">*</a></label>
                                <input class="form-control" type="file" disabled name="file">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category">
                                    ...
                                    <optgroup label="Category">
                                        ...
                                        <option value="Doctor" <?php if($name1['category'] == "Doctor"){echo 'selected="selected"';}?> >Doctor</option>
                                        <option value="Lab Technician" <?php if($name1['category'] == "Lab Technician"){echo 'selected="selected"';}?> >Lab Technician</option>
                                        <option value="Pharmacist" <?php if($name1['category'] == "Pharmacist"){echo 'selected="selected"';}?> >Pharmacist</option>
                                        <option value="Procurement" <?php if($name1['category'] == "Procurement"){echo 'selected="selected"';}?> >Procurement</option>
                                        <option value="Registry" <?php if($name1['category'] == "Registry"){echo 'selected="selected"';}?> >Registry</option>
                                    </optgroup>
                                </select>
                            </div>
                        </div>
