<?php 
    ...
    while($ros = mysql_fetch_array($result1)) {
        $rNo = $ros['RNO'];
        $queryx = "SELECT p.PID,p.name,p.capacity,r.PRID,r.RNO,r.QtyR
                        FROM product p,pharmacy_request r 
                        WHERE r.PID = p.PID 
                        AND r.QtyI = -1 
                        AND r.bar = '1' 
                        AND r.RNO ='$rNo' 
        ...
        $rowcount=  mysql_num_rows($resultx);
    }
...
<head>
    ...
    <title>Pharmacy Requisitions | Procurement | WAKA CMEC</title>
        ...
        <div class="page-content-wrapper">
            <div class="container-fluid"><a class="btn btn-link" role="button" href="#menu-toggle" id="menu-toggle"><i class="fa fa-bars"></i></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <hr style="margin:0px;">
                        <h2 style="font-weight:bold;font-style:normal;">Approve Pharmacy Requisitioned Item(s)</h2>
                        <hr style="margin:0px;">
                                    ...
                                    ?>
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th style="font-size:14px;">Pharmacy R/No. &nbsp; <label style="font-weight:normal;"><?php echo $ros['RNO']; ?></label></th>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped">
                                                    <thead>
                                                        ...
                                                        <?php while($rows = mysql_fetch_array($resultx)) { ?>
                                                            <tr style="color:black;">
                                                                <td>
                                                                    ...
                                                                    <input type="hidden" name="id[]" value="<?php echo $rows['PRID']; ?>" readonly style="display:none;" placeholder="Enter Request No.">
                                                                </td>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="text-align:right;">
                                                            <button name="pharmacy_save" type="submit" style="padding:5px 20px;color:rgb(1,1,1);">Approve</button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
