                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="qty" step="any" min="0" value="<?php echo $qty;?>" placeholder="Enter Quantity Per Item" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="pmin" step="any" min="0" value="<?php echo $pmin;?>" placeholder="Pharmacy&#39;s Item&#39;s Minimum Quantity" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
