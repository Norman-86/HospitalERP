                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" style="margin-top:20px;">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="qty" step="any" min="0" value="<?php echo $rows['qty'];?>" placeholder="Enter Quantity Per Item" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">Item Min. Qty for Pharmacy</label>
                                        <input type="number" name="pmin" step="any" min="0" value="<?php echo $rows['pharmacy_minimum'];?>" placeholder="Pharmacy&#39;s Item&#39;s Minimum Quantity" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
