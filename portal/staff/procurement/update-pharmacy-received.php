...
<head>
    ...
    <title>Update Pharmacy Received | Procurement | WAKA CMEC</title>
                                ...
                                if(!isset($_GET['id'])){
                                   echo'<div class="alert alert-danger absolue center text-center" role="alert">
                                    ...
                                    if(mysql_escape_string($_GET['id'])){
                                        // Get page data
                                        $query1 = "SELECT p.name AS Product,p.capacity,s.name AS Supplier,r.PPSID,r.PID,r.SID,r.Qty,r.price,r.contract,r.received FROM pharmacy_productsupplied r LEFT JOIN product p ON r.PID=p.PID RIGHT JOIN supplier s ON r.SID=s.SID WHERE PPSID=".$_GET['id'];
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group" style="margin-top:20px;">
                                        <button name="pharmacy_save" type="submit" value="<?php echo $row['PPSID']; ?>" style="padding:5px 20px;color:rgb(1,1,1);margin-right:auto;margin-left:auto;">Update Received</button>
                                    </div>
                                </div>
                            </div>
                            <?php }} ?>
