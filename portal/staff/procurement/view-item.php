                ...
                <div class="row">
                    <div class="col-md-12">
                        <hr style="margin:0px;">
                            ...
                            <div class="col-md-9">
                                <a href="view-pharmacy-item.php">
                                    <button style="padding:5px 20px;color:rgb(1,1,1);margin-top:5px;">View Pharmacy Stock</button>
                                </a>
                            </div>
                                            ...
                                            <table class="table table-striped" id="myTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-top:2px;padding-bottom:2px;text-align:center;">
                                                            <a href="form-s3.php?id=<?php echo $row['PID']?>" style="margin-right:5px;" target="_blank" title="View General Form S3 Card">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                        </td>
                                                        <td style="padding-top:2px;padding-bottom:2px;text-align:center;">
