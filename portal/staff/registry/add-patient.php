<?php 
    ...
    if(isset($_POST['r_id'])) {
      $sql = "select cost from `rates` where `rateID`=".mysql_real_escape_string($_POST['r_id']);
      $res = mysql_query($sql);
                    ...
                    <div id="formdiv">
                        ...
                        <?php 
                            ...
                            if(isset($_SESSION['new'])=='True' && isset($_SESSION['balance']))
                            {
                                ...
                                echo'<div class="alert alert-success absolue center text-center" role="alert">
                                        <span class="text-success">Patient successfully Added<br>Patient Balance is: <b>Kshs.'.$balance.'</b></span>
                        ...
                        <div id="printReport">
                            <div class="col-md-12" id="hidden_div" style="font-size:12px;">
                                ...
                                <br>
                                <b>name: &nbsp;</b> <?php echo $_SESSION['patientName'];?>
                                <br>
                                <b>Gender: &nbsp;</b> <?php echo $_SESSION['gender'];?>
                                <br>
                                <b>Age: &nbsp;</b> <?php $today = date("Y-m-d");
                                                            $diff = date_diff(date_create($_SESSION['dob']), date_create($today));
                                                            echo $diff->format('%y')." yrs.";
                                                        ?>    
                                <br>
                                <b>Patient No: &nbsp;</b> <?php echo $_SESSION['patientNo'];?>
                                <br>
                                <b>Visit No: &nbsp;</b> <?php echo $_SESSION['visitNo'];?>
                                <br>
