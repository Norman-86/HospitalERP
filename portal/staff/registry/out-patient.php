...
<head>
    ...
    <title>Out Patient | Registry | WAKA CMEC Hospital</title>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size:12px;font-weight:normal;padding-top:4px;padding-bottom:4px;"> 
                                            <?php
                                                if($row['level']==5){
                                            ?>
                                                <a href="prescription_payment.php?id=<?php echo $row['patientNo']?>&no=<?php echo $row['visitID']?>" title="Medical Prescription Charges">
