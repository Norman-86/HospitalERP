<?php 
    ...
    // Get page data
    $query1 = "SELECT p.*,v.visitID,v.dov,v.bedNo
            FROM $tableName p
                   LEFT JOIN (
                                SELECT t1.visitID,t1.dov,t1.patientNo,t1.status,t1.eov,t1.bedNo  
                                FROM visit t1
...
<head>
    ...
    <title>In Patient | Registry | WAKA CMEC Hospital</title>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" role="menu" style="background-color:rgb(249,249,249);">
                                ...
                                <!--<li class="active" role="presentation"><a href="in-patient.php">In Patient</a></li>-->
                            </ul>
                        </li>
                    </ul>
                </div>
                            ...
                            <table class="table table-striped" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size:12px;font-weight:normal;color:rgb(3,3,3);"> 
                                            <?php if($row['id'] == NULL){echo "__";}else{ echo $row['id'];}?>
                                        </td>
                                        <td style="font-size:12px;font-weight:normal;color:rgb(3,3,3);"> 
                                                <?php if($row['phone'] == NULL){echo "__";}else{ echo $row['phone'];}?>
                                        </td>
                                        <td style="font-size:12px;font-weight:normal;color:rgb(3,3,3);"> 
                                        ...
                                        <td style="font-size:12px;font-weight:normal;padding-top:4px;padding-bottom:4px;"> 
                                            <a href="payment.php?id=<?php echo $row['patientNo']?>&no=<?php echo $row['visitID']?>" title="Other Charges">
