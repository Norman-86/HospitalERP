...
<head>
    ...
    <title>Item Price | Accounts | WAKA CMEC Hospital</title>
                    ...
                    <form method="post" action="" onSubmit="return validate();">    
                        <?php 
                            ...
                            if(mysql_escape_string($_GET['id'])){
                                // Get page data
                                $query1 = "SELECT PID,name,Capacity,qty,minimum FROM product WHERE PID=".$_GET['id'];
                                $result = mysql_query($query1);
                            }
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" readonly name="product" value="<?php echo $rows['name'];?>" placeholder="Enter Item Name" autofocus="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="capacity" readonly value="<?php echo $rows['Capacity'];?>" placeholder="Capacity" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">Qty per Item <a class="text-danger">*</a></label>
                                        <input type="number" name="qty" readonly step="any" min="0" value="<?php echo $rows['qty'];?>" placeholder="Enter Item Per Quantity" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">Price per Qty per Item <a class="text-danger">*</a></label>
                                        <input type="number" name="price" step="any" min="0" value="<?php echo $rows['price'];?>" placeholder="Enter Price per Item Per Quantity" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="min" readonly step="any" min="0" value="<?php echo $rows['minimum'];?>" placeholder="Enter Item&#39;s Minimum Quantity" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group" style="margin-top:20px;color:black;">
                                        <button name="update" value="<?php echo $rows['PID'];?>" type="submit" style="padding:5px 20px;">Update Price</button>
                                    </div>
                                </div>
                            </div>
                        <?php }} ?>
