<?php 
    ...
    // Get page data
    $query1 = "SELECT p.name AS Product,p.Capacity,s.name AS Supplier,r.No,r.PPSID,r.Qty,r.price,r.contract,r.invoice,r.delivery,r.received FROM $tableName r LEFT JOIN product p ON r.PID=p.PID LEFT JOIN supplier s ON r.SID=s.SID ORDER BY PPSID DESC";
...
<head>
    ...
    <title>Received Pharmacy Items | Accounts | WAKA CMEC Hospital</title>
...
<body style="background-color:rgba(42,63,84,0);">
    ...
    <div class="row" style="width:98%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        <div style="padding-top:2px;padding-bottom:2px;background-color:rgb(239,239,239);">
            <h2 style="margin-left:1%;margin-bottom:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;"><i class="fa fa-reorder"></i> &nbsp;Received Pharmacy Items</h2>
        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;padding:2px;"><?php echo $row['Supplier'];?></td>
                                                    <td style="padding:2px;text-align:center;">
                                                        <a href="form-s13_pharmacy.php?id=<?php echo $row['No'];?>" title="Pharmacy Counter Receipt Vourcher" class="text-info" style="cursor:pointer;margin-right:5px;">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </td>   
                                            </tr>
