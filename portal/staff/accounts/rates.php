...
<head>
    ...
    <title>Rates | Accounts | WAKA CMEC Hospital</title>
...
<body style="background-color:rgba(42,63,84,0);">
    ...
    <div style="width:100%;max-width:960px;padding:0px;padding-right:0px;padding-left:auto;background-color:rgba(57,12,12,0);margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);">
        <form method="POST">
            <div class="col-md-12" style="padding-top:2px;padding-bottom:2px;background-color:rgb(239,239,239);">
                <h2 style="margin-left:1%;margin-bottom:1%;font-size:16px;color:rgb(1,1,1);font-weight:bold;"><i class="fa fa-thermometer"></i> &nbsp;Add Rate</h2>
            </div>
            <div class="row" style="padding:10px;">
                <div class="col-md-12">
                    <?php 
                        include 'validate/addRate.php';
                        ...
                        if(isset($_SESSION['success'])=="true"){
                            echo'<div class="alert alert-success absolue center text-center" role="alert">
                                    ...
                                    <span class="text-success">Rate Successfully Added</span>
                                </div>'; 
                    ...
                    <div class="row" style="padding:10px;">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="rate" required="" value="<?php echo $name;?>"  placeholder="Rate Name" autocomplete="off">
                            </div> 
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">Cost:</label>
                                <input class="form-control" type="number" name="cost" required="" value="<?php echo $cost;?>"  placeholder="Rate Cost" autocomplete="off">
                            </div> 
                        </div>
