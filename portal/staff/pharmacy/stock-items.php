...
<body style="background-color:rgba(42,63,84,0);">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active" role="presentation" id="StockCounter"></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="row" style="width:98%;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);margin-bottom:5%;overflow:hidden;">
        <form method="POST">
            <div class="col-md-12 bg-warning" style="margin-bottom:1%;padding-top:2px;padding-bottom:2px;">
                <h3 class="text-warning" style="margin-left:1%;margin-bottom:1%;font-size:13px;font-weight:bold;">
                                    ...
                                    <thead style="background-color:rgb(52,73,94);color:rgb(252,254,255);">
                                        <tr>
                                            <th style="text-align:center;width:40px;">
                                                <button type="submit" name="request" style="color:rgb(1,1,1);" onClick="return confirm('Sure you want to Requisition selected items??');">Requisition</button>
                                            </th>
                                            <th>Item </th>
