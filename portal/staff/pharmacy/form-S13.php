...
<head>
    ...
    <title>Form S13 | Accounts | WAKA CMEC Hospital</title>
    ...
    <script>
        ...
        function Popup(data) 
        {
            ...
            mywindow.document.write('<link rel="stylesheet" href="../../../assets/css/MUSA_no-more-tables.css"  media="print">');
            mywindow.document.write('<link rel="stylesheet" href="../../../assets/css/MUSA_panel-table.css"  media="print">');
            mywindow.document.write('<link rel="stylesheet" href="../../../assets/css/styles.css"  media="print">');
            mywindow.document.write('<link rel="stylesheet" href="../../../assets/css/tabela-mloureiro1973.css"  media="print">');
...
<body style="background-color:rgb(255,255,255);width:100%;max-width:1000px;margin-right:auto;margin-left:auto;-webkit-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);-moz-box-shadow:0px 4px 4px 0px rgba(0,0,0,1);box-shadow:0px 4px 4px 0px rgba(0,0,0,1);font-size:12px;">
    <?php
        if(!isset($_GET['id'])){
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6"><img class="img-responsive" src="../../../assets/img/logo.png" alt="Logo: WAKA CMEC" style="width:100px;margin-top:0px;margin-right:auto;margin-left:auto;">
                    ...
                    <p class="text-center" style="color:rgb(4,4,4);font-size:16px;text-align:center;font-weight:bold;">ACCOUNTS COUNTER RECEIPT VOUCHER </p>
                </div>
                <div class="col-md-3">
        ...
        <div class="col-md-12" style="width:100%;padding-right:0px;padding-left:0px;">
            <div class="table-responsive" style="width:100%;">
                <table class="table table-striped" style="width:94%;margin-left:auto;margin-right:auto;">
                    <thead>
                        <tr>
                            <th class="col-md-1" style="font-weight:bold;color:rgb(3,3,3);border:1px solid black;font-size:12px;text-align:center;">#</th>
                            <th class="col-md-1" style="border:1px solid black;color:rgb(4,4,4);font-size:12px;text-align:center;">Code</th>
                            ...
                            <th class="col-md-1" style="color:rgb(3,3,3);border:1px solid black;font-size:12px;text-align:center;">Qty</th>
                            <th class="col-md-1" style="color:rgb(4,4,4);border:1px solid black;font-size:12px;text-align:center;">Value/U</th>
                            <th class="col-md-1" style="color:rgb(4,4,4);border:1px solid black;font-size:12px;text-align:center;">Value </th>
                            <th class="col-md-1" style="color:rgb(3,3,3);border:1px solid black;font-size:12px;text-align:center;">Qty/U</th>
                            <th class="col-md-1" style="color:rgb(3,3,3);border:1px solid black;font-size:12px;text-align:center;">Price/Q/U</th>
                            <th class="col-md-1" style="color:rgb(3,3,3);border:1px solid black;font-size:12px;text-align:center;">Price</th>
                            <th class="col-md-1" style="color:rgb(3,3,3);border:1px solid black;font-size:12px;text-align:center;">Profit</th>
                    ...
                    <tbody style="border-bottom:2px solid black;border-top:2px solid black;border-left:1px solid black;border-right:1px solid black;">
                        ...
                        <tr style="color:rgb(4,4,4);">
                            ...
                            <td style="border:1px solid black;font-size:12px;text-align:center;padding:2px;"><?php echo number_format($rows['price'],2)."/=";?></td>
                            <td style="border:1px solid black;font-size:12px;text-align:center;padding:2px;"><?php echo number_format(($rows['Qty']*$rows['price']),2)."/=";?></td>
                            <td style="border:1px solid black;font-size:12px;text-align:center;padding:2px;"><?php echo $rows['item_qty'];?></td> 
                            <td style="border:1px solid black;font-size:12px;text-align:center;padding:2px;"><?php echo number_format($rows['item_price'],2)."/=";?></td>
                            <td style="border:1px solid black;font-size:12px;text-align:center;padding:2px;"><?php echo number_format(($rows['Qty']*$rows['item_qty']*$rows['item_price']),2)."/=";?></td>
                            <td style="border:1px solid black;font-size:12px;text-align:center;padding:2px;"><?php echo number_format((($rows['Qty']*$rows['item_qty']*$rows['item_price'])-($rows['Qty']*$rows['price'])),2)."/=";?></td>
                        </tr>
                        <?php 
                                $value[] = $rows['Qty']*$rows['price'];
                                $price[] = $rows['Qty']*$rows['item_qty']*$rows['item_price'];
                                $profit[] = ($rows['Qty']*$rows['item_qty']*$rows['item_price'])-($rows['Qty']*$rows['price']);
                            } 
                        ?>
                    </tbody>
                    <tbody style="background-color:white;">
                        <tr style="background-color:white;color:black;">
                            <td colspan="6" style="border:none;padding:2px;font-size:12px;text-align:left;font-weight:bold;">Total:</td>
                            <td style="border:2px solid black;font-size:12px;text-align:center;padding:2px;">
                                <?php echo number_format(array_sum($value),2)."/=";?>
                            </td>
                            <td colspan="2"></td>
                            <td style="border:2px solid black;font-size:12px;text-align:center;padding:2px;">
                                <?php echo number_format(array_sum($price),2)."/=";?>
                            </td>
                            <td style="border:2px solid black;font-size:12px;text-align:center;padding:2px;">
                                <?php echo number_format(array_sum($profit),2)."/=";?>
                            </td>
                        </tr>
                    </tbody>
                </table>
