...
<head>
    ...
    <title>Requisition Items | Laboratory | WAKA CMEC Hospital</title>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody style="border:none;">
                            <tr style="background-color:transparent;">
                                ...
                                <td style="font-weight:normal;font-size:12px;color:rgb(6,6,6);text-align:center;border:none;">
                                    <input type="text" class="form-control" name="designation" value='Lab Technician' readonly placeholder="Enter Designation">
                                </td>
                            </tr>
                            <tr>
