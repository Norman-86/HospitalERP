<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $query1 = "SELECT name FROM test WHERE testID='$id' ";
...
<head>
    ...
    <title>Update Test | Laboratory | WAKA CMEC Hospital</title>
            ...
            <form method="POST">
                <div class="form-group">
                    <div id="formdiv">
                        ...
                        <?php 
                            include('validate/update-test.php'); 
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-12">
                                <p style="font-family:Roboto, sans-serif;font-size:12px;font-weight:bold;">Test Name <a class="text-danger">*<a/></p>
                                <input class="form-control" type="text" name="name" value="<?php echo $row['name'];?>" placeholder="Enter Test Name" style="margin-left:0px;font-family:Roboto, sans-serif;">
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px; text-align:center; padding-top:24px;">
                            <div class="col-md-12">
                                <button type="submit" name="submit" onClick="return confirm('Sure you want to update this test?')" style="padding:5px 20px;color:rgb(1,1,1);">Update</button>
                            </div>
                        </div>
                        <?php }} ?>
                    </div>
