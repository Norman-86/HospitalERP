...
<head>
    ...
    <title>Add Test | Laboratory | WAKA CMEC Hospital</title>
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" role="menu" style="background-color:rgb(249,249,249);">
                                <li class="active" role="presentation"><a href="add-test.php">Add Test</a></li>
                    ...
                    <div id="formdiv">
                        ...
                        <?php 
                            ...
                            if(isset($_SESSION['new'])=='True')
                            {
                                ...
                                echo'<div class="alert alert-success absolue center text-center" role="alert">
                                        ...
                                        <span class="text-success">Test Added Successfully:</b></span>
                                    </div>';
                                    unset($_SESSION['new']); 
                            }
                        ?>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="text" name="name" value="<?php echo $name;?>" placeholder="Enter Test Name" style="margin-left:0px;font-family:Roboto, sans-serif;">
                            </div>
                        </div>
